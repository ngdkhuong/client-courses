                    ...
                    >
                        <Form className="">
                            <div className="p-2  mt-6 ">
                                <h1 className="font-semibold text-md customFontColorBlack">Personal information's:</h1>
                            </div>
                                            ...
                                            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                                <div className="text-center">
                                                    ...
                                                    <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                                        ...
                                                        >
                                                            <span>
                                                                {certificateTwo ? 'Change file' : 'Upload a file '}
                                                            </span>
                                                            <Field
                                                                id="certificate-two"
                            ...
                            <div className="p-2 mt-4 mb-1  ">
                                <h1 className="font-semibold text-md customFontColorBlack">Account information's</h1>
                            </div>
                            <div className=" bg-white border border-gray-200 p-8 rounded-lg">
                                <div className="flex flex-wrap -mx-3 mb-4">
                                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
