        ...
        <div className="h-full pb-7">
            <div className="h-2/3 p-6 md:p-12 pb-10 md:pb-24 flex flex-col w-full bg-skyBlueCustom items-center justify-center">
                <div className="block text-center">
                    <h1 className="p-2 text-customFontColorBlack text-3xl md:text-4xl font-bold">Our Instructors</h1>
                </div>
                    ...
                    <div className="w-full md:p-10 md:w-1/4 h-auto lg:p-5 lg:pt-10 md:h-full">
                        <div className="  flex flex-col items-center ">
                            <div className=" text-center">
                                <Avatar
                                    sx={{
                                        height: 128, // 32 * 4 (assuming 1rem = 16px)
                                        width: 128, // 32 * 4 (assuming 1rem = 16px)
                                        mx: 'auto',
                                        mt: { sm: 5 }, // 5 * 8px (assuming spacing unit = 8px)
                                    }}
                                    src={
