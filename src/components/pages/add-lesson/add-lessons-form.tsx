...
const AddLessonForm: React.FC = () => {
    ...
    const handleSubmit = async (lesson: FormValuesLesson, { resetForm }: FormikHelpers<FormValuesLesson>) => {
        try {
            ...
            toast.success('Failed to add lesson', {
                position: 'bottom-right',
            });
        }
    };
    ...
    return (
        <div className="flex justify-center items-center mt-10 pt-5 pb-10 text-customFontColorBlack ">
            <div className="bg-white rounded-lg mx-10 border w-full p-6">
                ...
                <Formik initialValues={initialValues} validationSchema={lessonSchema} onSubmit={handleSubmit}>
                    {({ values }) => (
                        <Form className="mt-10 space-y-6">
                            ...
                            <div className="flex justify-center">
                                <button type="submit" color="bg-blue">
                                    Add Lesson
                                </button>
                            </div>
                        </Form>
