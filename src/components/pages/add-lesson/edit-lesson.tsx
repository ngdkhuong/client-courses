...
import { getLessonById, editLesson } from '../../../api/endpoints/course/lesson';
import { getQuizzesByLesson } from '../../../api/endpoints/course/quiz';
import { ApiResponseLesson } from '../../../api/types/apiResponses/api-response-lesson';
...
const EditLessonForm: React.FC = () => {
    ...
    const handleSubmit = async (lesson: FormValuesLesson, { resetForm }: FormikHelpers<FormValuesLesson>) => {
        try {
            setIsUploading(true);
    ...
    return (
        <div className="mb-10">
            <div>
                <h2 className="font-semibold mt-3 mb-2 pt-2 text-xl text-customFontColorBlack">Edit the lesson</h2>
            </div>
