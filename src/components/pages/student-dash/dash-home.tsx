                    ...
                    <div className="border my-5 md:mt-0 md:w-4/12 w-full h-full bg-white rounded-md border-gray-300">
                            ...
                            <Tooltip
                                title={
                                    <div className="w-80">
                                        ...
                                        <Typography variant="caption" color="white" className="font-normal opacity-80">
                        ...
                        <div className="m-4 bg-gray-200 rounded-md">
                            <h2 className="text-sm font-light p-2">
                                Make it a habit! Each day that you complete a lecture, practice with a lab, or take a
                                quiz or exam you'll build your learning streak.
                            </h2>
                        </div>
                    </div>
                </div>
